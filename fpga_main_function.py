...
def compare_these_packets(date_time):
    ...
    if(int1_vals[0:size_val]==int2_vals[0:size_val]):
        ...
        file_readme.close()
##################### Generate Model ########################
def model_generation(file_input, date_time,iteration):
    ...
    file_spec = open('model1\Spec_vals_'+str(iteration)+'.txt','w')
    ...
    file_xspeca = open('model1\Xspec_A_vals'+str(iteration)+'.txt','w')
    ...
    file_xspecb = open('model1\Xspec_B_vals'+str(iteration)+'.txt','w')
